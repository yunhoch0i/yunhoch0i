![header](https://capsule-render.vercel.app/api?type=waving&height=300&color=B2CCFF&text=Yunho%&fontColor=FFFFFF)

안녕하세요. 보안과 인프라에 관심이 많은 최윤호입니다.

---
### ME
- 동국대학교 컴퓨터공학과에 다니고 있어요.
- 클라우드 보안에 관심이 있어요.
- DevSecOps 환경을 구축하는 것을 목표로 공부하고 있어요.
- 많은 사람을 만나서 대화하고 지식을 공유하는 일에서 즐거움을 느껴요.


### Experience
- 동국대학교 프로그래밍 중앙동아리 [CAPS](http://dgucaps.kr) 집행부원 2023.09 - 2024.02
- 동국대학교 프로그래밍 중앙동아리 [CAPS](http://dgucaps.kr) 기획부장    2024.03 - 2024.08
